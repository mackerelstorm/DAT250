...
filenameMeas = "Meas_P04_Manuellkjoring_Y.txt"
...
filenameCalcOffline = "CalcOffline_P04_Manuellkjoring_6.txt"
#---------------------------------------------------------------------
...
def unpackMeasurement(rowOfMeasurement):
    ...
    joySide.append(float(rowOfMeasurement[7]))
...
def offline(filenameMeas, filenameCalcOffline):
    ...
    with open(filenameMeas) as f:
        ...
        for EachRow in MeasurementFromFile:
            ...
            MathCalculations(e ,Lys, IAE, Tid, MAE, u, o, TVa, TVb, PowerA, PowerB, joyForward, joySide)
            #---------------------------------------------------------
        ...
        if len(filenameCalcOffline)>4:
            with open(filenameCalcOffline, "w") as f:
                ...
                CalculatedToFileHeader += "0=PowerA, 1=PowerB, \n"
                CalculatedToFileHeader += "2=e, 3=TVa, 4=TVb, 5=IAE, 6=MAE, 7=u, 8=o, \n"
